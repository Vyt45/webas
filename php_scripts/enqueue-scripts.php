...
//     Didact Gothic
//    wp_enqueue_style( 'google-font-css', 'https://fonts.googleapis.com/css?family=Open+Sans:300,300italic', array(), '', 'all' );

    // Font-awesome
    wp_enqueue_style( 'font-awesome-css', 'https://maxcdn.bootstrapcdn.com/font-awesome/4.6.2/css/font-awesome.min.css', array(), '', 'all' );
